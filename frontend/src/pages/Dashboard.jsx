  ...
  return (
    <PageTransition>
      <div className="min-h-screen pt-32 px-6 md:px-12 pb-20">
        ...
        {/* Bento Grid Layout */}
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <div className="flex justify-center pb-12">
          <Link to="/products">
            <GlowButton className="px-8 py-3 text-sm font-bold uppercase tracking-widest bg-white text-black hover:bg-gray-200 shadow-xl shadow-white/10">
              View All Products
            </GlowButton>
          </Link>
        </div>
