    ...
    <div className="min-h-screen">
      ...
      <div className="bg-teal-900 text-white py-20 px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <button onClick={() => document.getElementById('products-section').scrollIntoView({ behavior: 'smooth' })} className="bg-white text-teal-900 px-8 py-3 rounded-full font-bold hover:bg-teal-50 transition shadow-lg">
            Start Shopping
          </button>
        </div>
      </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {categories.map((cat) => (
              <button
                ...
                className="group bg-white p-6 rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col items-center gap-4"
              >
                ...
                <div key={product._id} className="modern-card group flex flex-col h-full overflow-hidden">
                  ...
                  <div className="relative h-64 overflow-hidden bg-gray-100">
                    ...
                    {product.stock === 0 && (
                      <div className="absolute inset-0 bg-white/60 flex items-center justify-center">
                        <span className="bg-red-500 text-white px-4 py-1 rounded-full text-sm font-bold shadow-md">Out of Stock</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    <div className="flex justify-between items-start mb-2">
                      <p className="text-xs font-semibold text-teal-600 bg-teal-50 px-2 py-1 rounded-md">
                        {product.category}
                      </p>
