...
import { FaBoxOpen, FaImage, FaTag, FaLayerGroup, FaDollarSign, FaWarehouse, FaCloudUploadAlt, FaTrash } from 'react-icons/fa'
                    ...
                    <div className="relative group">
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          setLoading(true); // Re-use loading state or create separate 'uploading' state
